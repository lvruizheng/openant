					...
					<ul style="padding-left: 0">
						...
						<li><a href="#"><?php echo $menu['name'];?></a>
							...
							<ul>
								...
								<li><a href="<?php echo $this->config->item('catalog').'product/category?id='.$menu['category_id'].'_'.$child_['category_id'];?>"><?php echo $child_['name']; ?></a></li>
								<?php endforeach; ?>
							</ul>
							<?php endforeach; ?>
						</li>
						<?php else:?>
						<li><a href="<?php echo $this->config->item('catalog').'product/category?id='.$menu['category_id'];?>"><?php echo $menu['name'];?></a></li>
						<?php endif;?>
						<?php endforeach;?>
						<?php endif;?>
					</ul>
