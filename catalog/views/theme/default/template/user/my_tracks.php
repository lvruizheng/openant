				...
				<div class="panel-body">
					...
					<div class="media">
						<div class="media-left media-middle">
							<a href="<?php echo $this->config->item('catalog').'product?product_id='.$track['product']['product_id'];?>">
						...
						<div class="media-body">
							...
							<div class="col-sm-12">
								<p class="media-heading"><a href="<?php echo $this->config->item('catalog').'product?product_id='.$track['product']['product_id'];?>"><?php echo $track['product']['name']?></a></p>
