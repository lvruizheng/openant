...
<div class="weui-content">
  <div class="weui-cells weui-cells_form wy-address-edit">
	<form action="<?php echo $this->config->item('catalog').'user/signin/signinup';?>" method="post" enctype="multipart/form-data" id="signup">
		<div class="weui-cell">
		  ...
		  <div class="weui-cell__bd"><input class="weui-input" type="text" name="email" id="email" placeholder="<?php echo lang_line('email');?>"></div>
		</div>
		<div class="weui-cell">
		  <div class="weui-cell__hd"><label class="weui-label wy-lab">验证码</label></div>
		  <div class="weui-cell__bd"><input class="weui-input" type="text" id="captcha" name="captcha" placeholder="<?php echo lang_line('captcha');?>"></div>
		...
		<div class="weui-cell">
		  ...
		  <div class="weui-cell__bd"><input class="weui-input" type="text" name="password" id="password" pattern="[0-9]*" placeholder="<?php echo lang_line('password');?>"></div>
		</div>
		<div class="weui-cell">
		  <div class="weui-cell__hd"><label class="weui-label wy-lab">昵称</label></div>
		  <div class="weui-cell__bd"><input class="weui-input" type="text" id="nickname" name="nickname" pattern="[0-9]*" placeholder="<?php echo lang_line('nickname');?>" ></div>
		</div>
	
  </div>
  <label for="weuiAgree" class="weui-agree">
    <input id="weuiAgree" name="agree" type="checkbox" class="weui-agree__checkbox" value="1"><?php echo lang_line('agree');?>
  ...
  <div class="weui-btn-area"><a href="javascript:;" onclick="submit_on()" class="weui-btn weui-btn_warn"><?php echo lang_line('register');?></a></div>
 </form> 
</div>
