...
<header class="wy-header">
  ...
  <div class="wy-header-title">修改支付密码</div>
</header>
<div class="weui-content">


<form action="<?php echo $this->config->item('catalog').'user/edit/edit_pay_password';?>" method="post" enctype="multipart/form-data" id="edit-paswd-form">
  <div class="weui-cells weui-cells_form wy-address-edit">
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label wy-lab">登陆密码</label></div>
      <div class="weui-cell__bd"><input class="weui-input" type="password" id="current_password" name="current_password" placeholder="请输入登陆密码"></div>
    </div>
    <div class="weui-cell">
      <div class="weui-cell__hd"><label class="weui-label wy-lab">支付密码</label></div>
      <div class="weui-cell__bd"><input class="weui-input" type="password" id="new_password" name="new_password" placeholder="支付密码"></div>
    </div>
	<div class="weui-cell">
