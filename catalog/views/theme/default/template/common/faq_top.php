							...
							<ul class="dropdown-menu megamenu-content" role="menu">
								<li>
									<div class="col-menu col-md-3">
										...
										<ul class="menu-col">
											<li>
												<a href="<?php $this->config->item('catalog').'user/forget';?>"><?php echo lang_line('forget');?></a>
											</li><hr>
											<li>
									...
									<div class="col-menu col-md-3">
                                        ...
                                        <?php if($nav_infomation['informations']):?>
                                            <ul class="menu-col">
                                                ...
                                                <li>
												<a href="<?php $this->config->item('catalog').'helper/faq?inforation_id='.$information['information_id'];?>#inforation-<?php echo $information['information_id'];?>"><?php echo $information['title'];?></a>
												</li><hr>
                                                <?php endforeach;?>
                                            </ul>
                                        <?php endif;?>
        ...
        <div class="container">  
            ...
            <div id="navbar-menu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-left category-menu">
                	<li><a href="<?php echo $this->config->item('catalog');?>">商城</a></li>
                	<?php if($menus):?>
				...
				<div class="modal-content well">
					...
					<div class="modal-footer mylogin-footer" style="text-align: center; padding-left: 0; padding-right: 0">
						...
						<a onclick="with_login('<?php echo $key;?>');">
							<img width="32px" height="32px" class="lazy" data-original="resources/public/resources/default/image/login_ico/<?php echo $value['setting']['image'];?>" data-toggle="tooltip" data-placement="top" title="<?php echo $value['setting']['extra'];?>">
						</a>
						<?php endforeach;?>
					</div>
				</div>
...
<div id="mobile-menu" class="well">
	<ul>
		...
		<li class="text-center" style="width: 20%"><a href="<?php echo $this->config->item('catalog').'common/mobile_nav';?>"><i class="glyphicon glyphicon-th-list"></i>分类</a></li>
