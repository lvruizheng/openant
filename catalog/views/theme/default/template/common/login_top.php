<body id="<?php echo $css;?>">
	<div id="header">
	<!-- Start Navigation -->
		<nav class="navbar center-side bootsnav hidden-xs" id="nav-top">
			<div class="container">
								...
								<li>
									...
									<div class="col-menu col-md-3">
										...
										<ul class="menu-col">
											...
											<li>
												<a href="<?php $this->config->item('catalog').'product/category?id='.$category['category_id'];?>"><?php echo $category['name'];?></a>
											</li><hr>
											<?php endforeach;?>
											<?php endif;?>
									...
									<div class="col-menu col-md-3">
                                        ...
                                        <?php if($nav_infomation['informations']):?>
                                            <ul class="menu-col">
                                                ...
                                                <li>
												<a href="<?php echo $this->config->item('catalog').'helper/faq?inforation_id='.$information['information_id'];?>#inforation-<?php echo $information['information_id'];?>"><?php echo $information['title'];?></a>
												</li><hr>
                                                <?php endforeach;?>
                                            </ul>
                                        <?php endif;?>
	...
	<div id="mobile-menu" class="well">
		<ul>
			...
			<li class="text-center" style="width: 20%"><a href="<?php echo base_url();?>"><i class="glyphicon glyphicon-tree-deciduous"></i>论坛</a></li>
			<li class="text-center" style="width: 20%"><a href="<?php echo $this->config->item('catalog').'common/mobile_nav';?>"><i class="glyphicon glyphicon-th-list"></i>管理</a></li>
			<li class="text-center" style="width: 20%"><a href="<?php echo $this->config->item('catalog').'user/wecome';?>"><i class="glyphicon glyphicon-user"></i>商家</a></li>
		</ul>
	</div>
