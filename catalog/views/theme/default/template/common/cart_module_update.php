<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" id="page-cart">
    ...
    <ul class="dropdown-menu cart-list">
		...
		<li ><a target="_blank" href="<?php echo $this->config->item('catalog').'user/cart';?>" class="text-center" style="padding-bottom: 0;padding-top: 0;border-bottom-width: 0">...更多...</a></li>

		<?php endif;?>
		<li class="total">
            <span class="pull-right">总价：<?php echo $total;?></span>
            <a href="<?php echo $this->config->item('catalog').'user/cart';?>" class="btn btn-default btn-sm btn-cart" style="padding: 5px 15px">结算</a>
        </li>
		<?php else:?>
