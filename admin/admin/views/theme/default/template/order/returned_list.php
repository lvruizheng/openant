				...
				<table class="table" style="margin: 10px 0;border:1px solid rgb(217, 217, 217);">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center col-md-2 col-sm-2 col-xs-2 border-right"><span><?php echo $return['status_name']; ?></span><br/><span><?php echo $return['return_action']; ?></span><br/><a target="_blank" href="<?php echo $this->config->item('admin').'order/returned/info?rowid='.$return['rowid'];?>">查看退换详情</a></td>
						</tr>
						<?php endforeach;?>
					</tbody>
				</table>
