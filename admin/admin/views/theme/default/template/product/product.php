				...
				<div class="panel-body">
					<form action="<?php echo $invalid; ?>" method="post" enctype="multipart/form-data" id="form-category">
						...
						<tr>
							...
							<td><a target="_blank" href="<?php echo $this->config->item('catalog');?>/product?product_id=<?php echo $product['product_id'];?>"><img width="<?php echo $this->config->get_config('wish_cart_image_size_b_w');?>px" height="<?php echo $this->config->get_config('wish_cart_image_size_b_h');?>px" class="lazy" data-original="<?php echo $product['image'];?>"></a></td>
							<td><a target="_blank" href="<?php echo $this->config->item('catalog');?>/product?product_id=<?php echo $product['product_id'];?>"><?php echo utf8_substr($product['name'], 0, 30);?></a></td>
