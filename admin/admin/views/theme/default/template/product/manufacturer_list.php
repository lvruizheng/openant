			...
			<div class="panel panel-default">
				<div class="panel-heading row row-panel-heading bg-info">
					...
					<div class="navbar-right btn-group" style="margin-right: 0">
						<a href="<?php echo $this->config->item('admin').'product/manufacturer/add'?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i></a>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-right"><a href="<?php echo $this->config->item('admin').'product/manufacturer/edit?manufacturer_id='.$manufacturer['manufacturer_id']?>" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-edit"></i></a>
									</td>
								</tr>
								<?php endforeach;?>
								<?php endif;?>
