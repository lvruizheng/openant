								...
								<div class="tab-content" id="language-form">
									...
									<div role="tabpanel" class="tab-pane" id="language<?php echo $language['language_id']?>">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="official_meta_title[<?php echo $language['language_id']?>]" id="input-title<?php echo $language['language_id']?>" placeholder="官网标题" value="<?php echo isset($official_meta_title[$language['language_id']]) ? $official_meta_title[$language['language_id']] : ''; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" name="official_meta_keyword[<?php echo $language['language_id']?>]" id="input-keyword<?php echo $language['language_id']?>" placeholder="官网seo关键词" value="<?php echo isset($official_meta_keyword[$language['language_id']]) ? $official_meta_keyword[$language['language_id']] : ''; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<textarea name="official_meta_description[<?php echo $language['language_id']; ?>]" id="input-description<?php echo $language['language_id']; ?>" class="form-control" placeholder="官网描述"><?php echo isset($official_meta_description[$language['language_id']]) ? $official_meta_description[$language['language_id']] : ''; ?></textarea>
											</div>
										</div>
									</div>
									<?php endforeach;?>
