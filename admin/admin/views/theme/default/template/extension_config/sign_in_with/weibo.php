    ...
    <div class="col-md-12 middle-flat-left">
      <div class="panel panel-default">
        ...
        <div class="panel-body page-tab">
          <form action="<?php echo $this->config->item('admin').'extension_config/sign_in_with/weibo/add';?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
