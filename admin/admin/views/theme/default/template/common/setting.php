			...
			<div class="col-md-6 middle-flat-left">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<hr>
						<div class="form-group">
							<label class="col-sm-2 control-label" for="request_refund">
								申请退款
							</label>
							<div class="col-sm-10">
								<select id="request_refund" name="request_refund" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($request_refund) && $request_refund == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
									else:?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>">
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php endif;?>
									<?php endforeach;?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="merchant_confirmation">
								商家同意退款
							</label>
							<div class="col-sm-10">
								<select id="merchant_confirmation" name="merchant_confirmation" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($merchant_confirmation) && $merchant_confirmation == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="merchant_refused">
								商家拒绝退款
							</label>
							<div class="col-sm-10">
								<select id="merchant_refused" name="merchant_refused" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($merchant_refused) && $merchant_refused == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="wait_returns">
								等侍退货
							</label>
							<div class="col-sm-10">
								<select id="wait_returns" name="wait_returns" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($wait_returns) && $wait_returns == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="returns_goods">
								退货中
							</label>
							<div class="col-sm-10">
								<select id="returns_goods" name="returns_goods" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($returns_goods) && $returns_goods == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="wait_m_returns">
								等待商家退款
							</label>
							<div class="col-sm-10">
								<select id="wait_m_returns" name="wait_m_returns" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($wait_m_returns) && $wait_m_returns == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="waiting_c_payments">
								等待客户收款
							</label>
							<div class="col-sm-10">
								<select id="waiting_c_payments" name="waiting_c_payments" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($waiting_c_payments) && $waiting_c_payments == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="returns_goods_success">
								退款成功
							</label>
							<div class="col-sm-10">
								<select id="returns_goods_success" name="returns_goods_success" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($returns_goods_success) && $returns_goods_success == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="intervention">
								平台介入
							</label>
							<div class="col-sm-10">
								<select id="intervention" name="intervention" class="form-control">
									...
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($intervention) && $intervention == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="platform_refused">
								平台拒绝退款
							</label>
							<div class="col-sm-10">
								<select id="platform_refused" name="platform_refused" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($platform_refused) && $platform_refused == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" for="cancellation_refund">
								客户撤销退款
							</label>
							<div class="col-sm-10">
								<select id="cancellation_refund" name="cancellation_refund" class="form-control">
									<?php
									if($return_statuss):?>
									<?php
									foreach($return_statuss as $k=>$v):?>
									<?php
									if(isset($cancellation_refund) && $cancellation_refund == $return_statuss[$k]['return_status_id']):?>
									<option value="<?php echo $return_statuss[$k]['return_status_id']?>" selected>
										<?php echo $return_statuss[$k]['status_name']?>
									</option>
									<?php
